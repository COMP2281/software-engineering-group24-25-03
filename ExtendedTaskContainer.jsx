import styles from './ExtendedTaskContainer.module.css';


const ExtendedTaskContainer = () => {
  	return (
    		<div className={styles.extendedTaskContainer}>
              							...
              							<div className={styles.taskNameField}>
                								<div className={styles.whatDoYou}>When must this task be finished?</div>
                  									...
                  									<div className={styles.assigneeField}>
                    										...
                    										export default ExtendedTaskContainer;
