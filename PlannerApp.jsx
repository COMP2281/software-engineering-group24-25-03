...
import RecentlyDeletedContainer from "../components/RecentlyDeletedContainer";
import styles from './PlannerApp.module.css';


const PlannerApp = () => {
  	const [isArchiveOpen, setArchiveOpen] = useState(false);
  	const [isRecentlyDeletedContainerOpen, setRecentlyDeletedContainerOpen] = useState(false);
  	...
  	const openRecentlyDeletedContainer = useCallback(() => {
    		setRecentlyDeletedContainerOpen(true);
  	}, []);
  	
  	const closeRecentlyDeletedContainer = useCallback(() => {
    		setRecentlyDeletedContainerOpen(false);
  	}, []);
  	...
  	return (<>
    		<div className={styles.plannerApp}>
      			<div className={styles.sidebar} onClick={onSidebarContainerClick}>
        				...
        				<div className={styles.listSection}>
          					...
          					<img className={styles.iconfolderPlus} alt="" src="icon/folder-plus.svg" />
          					...
          					<img className={styles.iconclipboard} alt="" src="icon/clipboard.png" />
        				</div>
        				<div className={styles.listName4} onClick={openArchive}>
          					<div className={styles.archive}>Archive</div>
          					<img className={styles.iconarchive} alt="" src="icon/archive.svg" />
        				</div>
        				<div className={styles.listName5} onClick={openRecentlyDeletedContainer}>
          					<div className={styles.recentlyDeleted}>
            						<div className={styles.archive}>Recently Deleted</div>
            						<img className={styles.iconarchive} alt="" src="icon/trash-2.svg" />
          					</div>
        				</div>
      			</div>
    		...
    		{isArchiveOpen && (
      			<PortalPopup
        				...
        				onOutsideClick={closeArchive}
        				>
        				<Archive onClose={closeArchive} />
      			</PortalPopup>
    		)}
    		{isRecentlyDeletedContainerOpen && (
      			<PortalPopup
        				overlayColor="rgba(113, 113, 113, 0.3)"
        				placement="Centered"
        				...
        				onOutsideClick={closeRecentlyDeletedContainer}
        				>
        				<RecentlyDeletedContainer onClose={closeRecentlyDeletedContainer} />
      			</PortalPopup>
    		)}</>);
};
